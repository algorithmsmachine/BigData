 ...
 *   Datatype of the input key
 *   Datatype of the input value
 *   Datatype of the output key (which is the input key type for the reducer)
 *   Datatype of the output value (which is the input value type for the reducer)
 */
